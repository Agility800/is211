...
class HomeTemplate extends BaseTemplate
{
  public function getHomeTemplate(): string
  {
    ...
    $str .= <<<END
            ...
            <div id="carouselExample" class="carousel slide  " data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./img/png1.jpg" class="d-block w-100"  height="1000">
                    </div>
                    <div class="carousel-item">
                        <img src="./img/png2.jpg" class="d-block w-100"  height="1000">
                    </div>
                    <div class="carousel-item">
                        <img src="./img/png3.jpg" class="d-block w-100"  height="1000">
                    </div>
                </div>
        ...
        <div class="row mt-5">
            <p>
                Приглашаем в наш онлайн-магазин "Dress"!
            </p>
            <p>
